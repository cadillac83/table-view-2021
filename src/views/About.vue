      ...
      <el-tab-pane label="建造合同准则" name="first">
        ...
        <el-table :data="mcaList" style="width: 100%" :height="height" stripe>
          ...
          <el-table-column label="主合同金额">
            <el-table-column
              prop="mainContractAmount.total"
              label="总额"
              width="120"
            />
            <el-table-column label="细分" width="120">
              <el-table-column
                prop="mainContractAmount.constructionSafety"
                label="建安"
                width="120"
              />
              <el-table-column
                prop="mainContractAmount.equipmentProcurement"
                label="设备采购"
                width="120"
              />
              <el-table-column
                prop="mainContractAmount.other"
                label="其他"
                width="120"
              />
            </el-table-column>
          ...
          <el-table-column label="预计总收入">
            <el-table-column
              prop="estimatedtotalRevenue.total"
              label="总额"
              width="120"
            />
            <el-table-column label="细分" width="120">
              <el-table-column
                prop="estimatedtotalRevenue.constructionSafety"
                label="建安"
                width="120"
              />
              <el-table-column
                prop="estimatedtotalRevenue.equipmentProcurement"
                label="设备采购"
                width="120"
              />
              <el-table-column
                prop="estimatedtotalRevenue.other"
                label="其他"
                width="120"
              />
            </el-table-column>
          ...
          <el-table-column label="预计总成本">
            <el-table-column
              prop="estimatedTotalCost.total"
              label="总额"
              width="120"
            />
            <el-table-column label="细分" width="120">
              <el-table-column
                prop="estimatedTotalCost.constructionSafety"
                label="建安"
                width="120"
              />
              <el-table-column
                prop="estimatedTotalCost.equipmentProcurement"
                label="设备采购"
                width="120"
              />
              <el-table-column
                prop="estimatedTotalCost.other"
                label="其他"
                width="120"
              />
            </el-table-column>
...
v-model="form.mainContractAmount.total"
          ...
          <el-row>
            <el-col :span="8">
              <el-input v-model="form.mainContractAmount.constructionSafety">
                <template #prepend>建安</template></el-input
              >
            </el-col>
            <el-col :span="8">
              <el-input
...
v-model="form.estimatedtotalRevenue.total"
          ...
          <el-row>
            <el-col :span="8">
              <el-input v-model="form.estimatedtotalRevenue.constructionSafety">
                <template #prepend>建安</template></el-input
              >
            </el-col>
            <el-col :span="8">
              <el-input
                v-model="form.estimatedtotalRevenue.equipmentProcurement"
                ><template #prepend>设备采购</template></el-input
              >
            </el-col>
            <el-col :span="8">
